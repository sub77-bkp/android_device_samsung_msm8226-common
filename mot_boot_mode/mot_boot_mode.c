...
#define MOTO_PU_REASON_CHARGE_ONLY    "0x00000010" //0x00000010 = usb_cable     0x00000100 (original)
#define MOTO_PU_REASON_CPCAP_RESET    "0x00040000" //0x00004000 = reboot
#define MOTO_PU_REASON_KPANIC 	      "0x00020000"
#define MOTO_PU_REASON_WDRESET        "0x00008000" //0x00000080 = power_key_press
...
int main(int argc, char **argv)
{
    ...
    if (check_cid_recover_boot()){
        ...
        property_set("ro.product.model", "recovery");

    }else if (boot_reason_charge_only()){

    	ALOGD("MOTO_PUPD: boot_reason_charge_only: 1\n");
        property_set("ro.bootmodesssss", "mot-charger");
        property_set("ro.bootmode", "mot-charger");
